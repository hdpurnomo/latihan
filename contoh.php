          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="download">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="https://bootswatch.com/4/pulse/bootstrap.min.css">bootstrap.min.css</a>
                <a class="dropdown-item" href="https://bootswatch.com/4/pulse/bootstrap.css">bootstrap.css</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="https://bootswatch.com/4/pulse/_variables.scss">_variables.scss</a>
                <a class="dropdown-item" href="https://bootswatch.com/4/pulse/_bootswatch.scss">_bootswatch.scss</a>
              </div>
            </li>
          </ul>
      ...
      <div class="page-header" id="banner">
        <div class="row">
          <div class="col-lg-8 col-md-7 col-sm-6">
            <h1>Pulse</h1>
            <p class="lead">A trace of purple</p>
          </div>
          <div class="col-lg-4 col-md-5 col-sm-6">
            <div class="sponsor">
              <a href="https://www.shopify.com/?ref=bootswatch">
                <img src="Bootswatch%20%20Pulse_files/shopify-300x250-light2x.jpg" style="display: none !important;">
              </a>
            </div>
          </div>
        </div>
